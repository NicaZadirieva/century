    ...
    return (
        <header>
          <div className="desk-header-contact desk flex-row justify-content-between">
               ...
               <div onClick={showForm} className="btn btn-call d-flex flex-column justify-content-center">
          ...
          <div className="desk-menu desk position-absolute">
              <ul>
                <li><a href="#">Капельное орошение</a></li>
                <li><a href="#">Упаковка для овощных культур</a></li>
                <li><a href="#">Упаковка для кормовых культур</a></li>
              </ul>
          </div>
          ...
          <div className="mobile-header-list mobile">
              ...
              <div onClick={showForm} className="btn btn-call-mobile d-flex flex-column justify-content-center mobile">
                   <div>Заказать звонок</div>
               </div>
          </div>
          ...
          <div className="trailer position-relative">
                ...
                <div className="info-trailer">
                   ...
                   <p>
                       Мы создаем и внедряем инновационные технологии интеллектуального орошения,
                       повышающие эффективность сельского хозяйства и качество агрокультур
                   </p>
                </div>
          </div>
        </header>
